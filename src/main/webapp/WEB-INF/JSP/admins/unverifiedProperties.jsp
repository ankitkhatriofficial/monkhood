			...
			<table>
				...
				<c:forEach var="property" items="${properties}">
					<tr>
						...
						<td>${property.coupledAllowed ? 'Yes' : 'No'}</td>
						...
						<td><a
							href="${pageContext.request.contextPath}/admin/remove-unverified-properties/${property.id}"><button>Delete</button>
						</a> <a
							href="${pageContext.request.contextPath}/admin/modify-unverified-property/${property.id}"><button>Modify
									Details</button></a> <a
							href="${pageContext.request.contextPath}/admin/verify/property/${property.id}"><button>Verify</button>
						</a></td>
					</tr>
				</c:forEach>
