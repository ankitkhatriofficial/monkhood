...
public class PropertyReq implements Serializable {
	...
	private Date propertyReqDateTime;

	public Date getPropertyReqDateTime() {
		return propertyReqDateTime;
	}

	public void setPropertyReqDateTime(Date propertyReqDateTime) {
		this.propertyReqDateTime = propertyReqDateTime;
	}
	...
	@OneToMany(mappedBy = "propertyReq", cascade = CascadeType.ALL)
	private List<PropertyReqImage> propertyReqImages;

	public PropertyReq() {
		super();
		tenantType = new ArrayList<>();
		amenitiesProvided = new ArrayList<>();
		propertyReqImages = new ArrayList<>();
	}
	...
	public List<PropertyReqImage> getPropertyReqImages() {
		return propertyReqImages;
	}

	public void setPropertyReqImages(List<PropertyReqImage> propertyReqImages) {
		this.propertyReqImages = propertyReqImages;
	}
